...
public class DriverMethods {
	...
	public DriverMethods(WebDriver webDriver)
	{
		DriverMethods.webDriver = webDriver;
	}

	public void setxFID(String xFID)
	{
		DriverMethods.xFID = xFID;
	}

	public String getxFID()
	{
		return DriverMethods.xFID;
	}

	public WebDriver getWebDriver()
	{
		return DriverMethods.webDriver;
	}
...
/**
	 ...
	 */
	public List<WebElement> getAllFromDropdown(Element elem) {
